...
use arrow2::{
    datatypes::Schema,
    io::parquet::read::{infer_schema, read_metadata_async, RowGroupMetaData},
};
...
pub async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let file = File::open(OUTPUT_FILE_NAME).await?;
    ...
    println!(
        "Num Rows: {}, Num Groups: {}, Rows per Group: {}",
        num_rows, num_row_groups, rows_per_group
    );
